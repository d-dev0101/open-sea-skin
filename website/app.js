const translations = {
  zh: {
    ...
    downloadZip: '下载 v1.2.2 ZIP', oneCommand: '一键静态安装', staticBody: '从任意目录运行；自动备份、可重复更新、可安全卸载。',
  ...
  en: {
    ...
    downloadZip: 'Download v1.2.2 ZIP', oneCommand: 'One-command static install', staticBody: 'Run it from any directory, with automatic backup, repeatable updates, and safe uninstall.',
